  ...
  <div class="stat-grid">
    <div class="stat-box">
      <div>
        ...
        <div class="stat-box-val">{{ $stats['totalTournaments'] }}</div>
      </div>
    ...
    <div class="stat-box">
      <div>
        ...
        <div class="stat-box-val">{{ $stats['totalTeams'] }}</div>
      </div>
    ...
    <div class="stat-box">
      <div>
        ...
        <div class="stat-box-val">{{ $stats['totalMatches'] }}</div>
      </div>
    ...
    <div class="stat-box">
      <div>
        ...
        <div class="stat-box-val">{{ $stats['liveMatches'] }}</div>
      </div>
  ...
  <div class="dash-grid">
    <div class="panel">
      ...
      <div class="panel-body">
        @forelse($ongoingTournaments as $t)
          <div class="ongoing-item">
            <div>
              <div class="ongoing-name">{{ $t['name'] }}</div>
              <div class="ongoing-sport">{{ $t['sport'] }}</div>
            </div>
        ...
        @forelse($liveMatches as $m)
          <div class="live-card">
            <div class="live-card-top">
              ...
              <span class="live-venue">{{ $m['venue'] }}</span>
            </div>
            <div class="live-score-row">
              <div class="live-team">
                <div class="live-team-name">{{ $m['teamA'] }}</div>
                <div class="live-score">{{ $m['scoreA'] }}</div>
              </div>
              <div class="live-vs">vs</div>
              <div class="live-team" style="text-align:right">
                <div class="live-team-name">{{ $m['teamB'] }}</div>
                <div class="live-score">{{ $m['scoreB'] }}</div>
              </div>
            </div>
          </div>
        @empty
      ...
      @forelse($upcomingMatches as $m)
        <div class="upcoming-item">
          <div class="upcoming-dt">
            <div class="upcoming-date">{{ $m['date'] }}</div>
            <div class="upcoming-time">{{ $m['time'] }}</div>
          </div>
          <div style="flex:1">
            <div class="upcoming-match">{{ $m['teamA'] }} vs {{ $m['teamB'] }}</div>
            <div class="upcoming-venue">{{ $m['venue'] }}</div>
          </div>
